    ...
    for row in 0..grid_height {
        ...
        while col < grid_width {
            ...
            if grid[row][col].is_digit(10) {
                ...
                // check if adjacent to symbol and add to adjacent_numbers
    ...
    for row in 0..grid_height {
        ...
        for col in 0..grid_width {
            ...
            if grid[row][col] == '*' && adjacent_numbers[row][col].len() == 2 {
                // add product of adjacent numbers to sum
                sum += adjacent_numbers[row][col][0] * adjacent_numbers[row][col][1];
            }
        }
    }
