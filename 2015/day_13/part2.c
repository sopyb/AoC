...
int main() {
    ...
    strcpy(names[people_count], "You");
    int you_index = people_count;
    people_count++;

    // Set the happiness score for all relationships involving you to 0
    for (int i = 0; i < people_count; i++) {
        happiness[you_index][i] = 0;
        happiness[i][you_index] = 0;
    }
