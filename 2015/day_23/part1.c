...
// Solution time: 02:55.90 (mm:ss.ms)
// ? Doesn't include time it took to clean up the mess this code was initially
// ? it would be around ~5m if I would have taken that into a count.
typedef enum {
    HLF,
    TPL,
    INC,
